...
### 코멘트
 ...
 <p>벽 부수고 이동하기1에서는 벽을 한 번만 뚫을 수 있었는데 본 문제인 2에서는 벽을 K번 뚫을 수 있다. 그래서 3차원 배열 vis에서 뚫었냐 말았냐만 나타냈던걸 몇 번 뚫었냐를 나타내게 배열크기를 늘렸다. 또한 bfs 중에도 벽 뚫은 수에 맞게 코드를 살짝 바꿨더니 쉽게 해결 할 수 있었다.<p>  
